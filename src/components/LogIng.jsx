...
import { AiFillApple, AiFillTwitterSquare, AiFillFacebook, AiOutlineGoogle } from "react-icons/ai";
  ...
  return (
    <div>
      <div className='bg-white px-10 py-7 rounded-[32px] text-[#445100]'>
        <h1 className='font-bold text-3xl  text-center mb-10'>Вход</h1>
        <div>
        ...
        <Button>Войти</Button>
        <p className='font-normal text-center mt-5 text-sm'><a href="/restorepassword">Забыли пароль?</a></p>
      ...
      <div className='text-[#445100] text-center mt-3'>
        <p className='text-sm'><a href="#">Еще нет аккаунта?</a></p>
        <button className='bg-white w-[250px] rounded-sm border border-[#445100] text-sm font-semibold py-1 mt-3 hover:bg-[#445100] hover:text-white'>Зарегистрироваться</button>
      </div>
    </div>
  )
}
